...
var DocTemplateExamples = function DocTemplateExamples() {
  return /*#__PURE__*/_react.default.createElement(_DocTemplate.default, {
    ...
    examples: [{
      ...
      example: /*#__PURE__*/_react.default.createElement("p", null, "This very page was generated using the DocTemplate. The template supports more than one Props Table and example, even though those were not featured here.")
    }, {
      title: 'Package Badge Examples',
      source: _BadgeExamples2.default,
      example: /*#__PURE__*/_react.default.createElement(_BadgeExamples.default, null)
    }],
    propsTables: [{
